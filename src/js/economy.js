...
export const REWARDS = [
  {
    id: 'dip',
    title: 'Gratis Dip',
    subtitle: 'Ein Dip deiner Wahl zu jeder Bestellung',
    cost: 150,
    emoji: '🥫',
  },
  {
    id: 'drink',
    title: 'Softdrink 0,33 l',
    subtitle: 'Gratis Getränk zu jedem Menü',
    cost: 300,
    emoji: '🥤',
  },
  {
    id: 'wings',
    title: '6 Hot Wings',
    subtitle: 'Gratis Wings ab 10 € Bestellwert',
    cost: 600,
    emoji: '🔥',
  },
  {
    ...
    subtitle: 'Unser Signature Burger stark reduziert',
    cost: 900,
    emoji: '🍔',
  },
  {
    id: 'bucket',
    title: '20 % auf Family Bucket',
    subtitle: 'Für den großen Hunger mit Freunden',
    cost: 1500,
    emoji: '🍗',
  },
];
